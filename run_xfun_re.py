...
def main():
    ...
    parser = HfArgumentParser((ModelArguments, XFUNDataTrainingArguments, TrainingArguments, GOSEArguments))
    ...
    # Evaluation
    if training_args.do_eval:
        logger.info(f"**********Evaluate on {data_args.lang}**********")

        metrics = trainer.evaluate()
        print('length of eval',data_args.max_val_samples, len(eval_dataset))
