...
from LiLTfinetune.models.model_args import ModelArguments,GAREArguments
...
def main():
    ...
    parser = HfArgumentParser((ModelArguments, XFUNDataTrainingArguments, TrainingArguments, GAREArguments))
    ...
    if gare_args.use_trained_model and not training_args.do_train:
